...
Open an issue [here](https://github.com/) with the following information:
...
- Your mod has a `manifest.json` file, an example one can be found [here](https://github.com/).
- Provide information on how to update your mod if applicable, an example can be found [here](https://github.com/).
